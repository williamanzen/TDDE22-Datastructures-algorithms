 ...
 * Partially based on existing C++-laborations by Tommy Olsson and Filip Strömbäck.
 */
public class AVLTree<T extends Comparable<T>> {
     ...
     *
     * @param key - Generic parameter with the key value which to remove from the tree.
     */
